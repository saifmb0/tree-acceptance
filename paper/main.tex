...
\textbf{Target:} \texttt{TheBloke/\allowbreak Llama-2-7B-\allowbreak Chat-GPTQ}~\cite{touvron2023llama},
a 4-bit GPTQ-quantized variant of Llama-2-7B-Chat, fitting on a 16\,GB GPU.
\textbf{Draft:} \texttt{TinyLlama/\allowbreak TinyLlama-1.1B-\allowbreak Chat-v1.0}~\cite{zhang2024tinyllama},
...
All code and experiments are available at \url{https://github.com/saifmb0/tree-acceptance} 

The author thanks Dr. Armagan Elibol for valuable feedback on the manuscript
% ── References ───────────────────────────────────────────────────────
